...
const packed = [
  { id: "n1", label: "Nebulo 1", hint: "Primary workspace", p: "NCgoLC9mc3MvKDkxci4zPjM0KT5yLjNz" },
  {
    id: "n2",
    label: "Nebulo 2",
  ...
  { id: "n3", label: "Nebulo 3", hint: "Mirror workspace", p: "NCgoLC9mc3M0PShyLzkyOTszPzU9cj8wcw==" },
  {
    id: "n4",
    label: "Nebulo 4",
